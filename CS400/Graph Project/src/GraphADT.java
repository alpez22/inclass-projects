...
public interface GraphADT<NodeType,EdgeType extends Number> { 
    ...
    /**
     * Return the lowest sum of edge weights from 2 end locations
     *
     * @return the lowest sum of edge weights out of 2 end locations
     */
    public List<NodeType> minimumPath2(NodeType start, NodeType end1, NodeType end2);

    /**
     * Return the lowest sum of edge weights from 3 end locations
     *
     * @return the lowest sum of edge weights out of 3 end locations
     */
