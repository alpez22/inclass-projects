...
public class Artwork implements Comparable<Artwork> {
  ...
  public int compareTo(Artwork otherArtwork) {
    ...
    if(this.year == otherArtwork.getYear() && this.getName().equals(otherArtwork.getName()) && this.getCost() == otherArtwork.getCost()) {
      return 0;
    }else if(this.getYear() < otherArtwork.getYear()) {
      return -1;
    }else if(this.year == otherArtwork.getYear() && this.getCost() < otherArtwork.getCost()) {
      return -1;
    }else if(this.year == otherArtwork.getYear() && this.getCost() == otherArtwork.getCost() && this.getName().compareTo(otherArtwork.getName()) < 0) {
      return -1;
    }else {
      return 1;
    }
