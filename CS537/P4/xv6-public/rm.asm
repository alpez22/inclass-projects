...
free(void *ap)
{
 ...
 5c1:	a1 d8 07 00 00       	mov    0x7d8,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 d8 07 00 00       	mov    %eax,0x7d8
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 d8 07 00 00       	mov    %eax,0x7d8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 d8 07 00 00    	mov    0x7d8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 d8 07 00 00    	cmp    0x7d8,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 d8 07 00 00    	mov    0x7d8,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 d8 07 00 00    	mov    %edx,0x7d8
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 d8 07 00 00 dc 	movl   $0x7dc,0x7d8
 707:	07 00 00 
    base.s.size = 0;
 70a:	b8 dc 07 00 00       	mov    $0x7dc,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 dc 07 00 00 dc 	movl   $0x7dc,0x7dc
 716:	07 00 00 
    base.s.size = 0;
 719:	c7 05 e0 07 00 00 00 	movl   $0x0,0x7e0
 720:	00 00 00 
    if(p->s.size >= nunits){
