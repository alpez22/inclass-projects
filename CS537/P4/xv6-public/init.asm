...
free(void *ap)
{
 ...
 631:	a1 74 08 00 00       	mov    0x874,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 74 08 00 00       	mov    %eax,0x874
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 74 08 00 00       	mov    %eax,0x874
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 74 08 00 00    	mov    0x874,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 74 08 00 00    	cmp    0x874,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 74 08 00 00    	mov    0x874,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 74 08 00 00    	mov    %edx,0x874
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 74 08 00 00 78 	movl   $0x878,0x874
 777:	08 00 00 
    base.s.size = 0;
 77a:	b8 78 08 00 00       	mov    $0x878,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 78 08 00 00 78 	movl   $0x878,0x878
 786:	08 00 00 
    base.s.size = 0;
 789:	c7 05 7c 08 00 00 00 	movl   $0x0,0x87c
 790:	00 00 00 
    if(p->s.size >= nunits){
