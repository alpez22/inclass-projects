...
_wunmap:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  11:	6a 0e                	push   $0xe
  13:	68 00 10 00 00       	push   $0x1000
  18:	68 00 00 00 70       	push   $0x70000000
  1d:	e8 41 03 00 00       	call   363 <wmap>
    if (addr == (uint)-1) {
  22:	83 c4 10             	add    $0x10,%esp
  25:	83 f8 ff             	cmp    $0xffffffff,%eax
  28:	74 3a                	je     64 <main+0x64>
        exit();
    }
  ...
  40:	e8 26 03 00 00       	call   36b <wunmap>
  ...
  4c:	50                   	push   %eax
  4d:	50                   	push   %eax
  4e:	68 45 07 00 00       	push   $0x745
  53:	6a 01                	push   $0x1
  55:	e8 d6 03 00 00       	call   430 <printf>
        exit();
  5a:	e8 64 02 00 00       	call   2c3 <exit>
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 5e 07 00 00       	mov    $0x75e,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 f8 07 00 00       	mov    0x7f8,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 f8 07 00 00       	mov    %eax,0x7f8
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 f8 07 00 00       	mov    %eax,0x7f8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 f8 07 00 00    	mov    0x7f8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 f8 07 00 00    	cmp    0x7f8,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 f8 07 00 00    	mov    0x7f8,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 f8 07 00 00    	mov    %edx,0x7f8
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 f8 07 00 00 fc 	movl   $0x7fc,0x7f8
 707:	07 00 00 
    base.s.size = 0;
 70a:	b8 fc 07 00 00       	mov    $0x7fc,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 fc 07 00 00 fc 	movl   $0x7fc,0x7fc
 716:	07 00 00 
    base.s.size = 0;
 719:	c7 05 00 08 00 00 00 	movl   $0x0,0x800
 720:	00 00 00 
    if(p->s.size >= nunits){
