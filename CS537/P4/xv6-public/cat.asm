 ...
 651:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 80 0a 00 00    	mov    0xa80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 80 0a 00 00    	cmp    0xa80,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 ...
 78f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 84 0a 00 00       	mov    $0xa84,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 7a6:	0a 00 00 
    base.s.size = 0;
 7a9:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 7b0:	00 00 00 
    if(p->s.size >= nunits){
