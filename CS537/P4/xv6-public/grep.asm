 ...
 1f4:	31 ff                	xor    %edi,%edi
{
 ...
 21d:	50                   	push   %eax
 21e:	8d 81 20 0b 00 00    	lea    0xb20(%ecx),%eax
 224:	50                   	push   %eax
 ...
 23b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    buf[m] = '\0';
 23e:	bf 20 0b 00 00       	mov    $0xb20,%edi
 243:	89 de                	mov    %ebx,%esi
 245:	c6 81 20 0b 00 00 00 	movb   $0x0,0xb20(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2f2:	81 ff 20 0b 00 00    	cmp    $0xb20,%edi
 ...
 307:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 30a:	2d 20 0b 00 00       	sub    $0xb20,%eax
 30f:	29 45 e0             	sub    %eax,-0x20(%ebp)
 312:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      memmove(buf, p, m);
 315:	51                   	push   %ecx
 316:	57                   	push   %edi
 317:	68 20 0b 00 00       	push   $0xb20
...
0000069b <getwmapinfo>:
SYSCALL(getwmapinfo)
 69b:	b8 19 00 00 00       	mov    $0x19,%eax
 6a0:	cd 40                	int    $0x40
 6a2:	c3                   	ret

000006a3 <getpgdirinfo>:
...
free(void *ap)
{
 ...
 8e1:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 91f:	5b                   	pop    %ebx
  freep = p;
 920:	a3 20 0f 00 00       	mov    %eax,0xf20
}
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 927:	5d                   	pop    %ebp
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 20 0f 00 00       	mov    %eax,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 20 0f 00 00    	mov    0xf20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bb:	3b 05 20 0f 00 00    	cmp    0xf20,%eax
 ...
 9de:	e8 fd fe ff ff       	call   8e0 <free>
  return freep;
 9e3:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 a27:	0f 00 00 
    base.s.size = 0;
 a2a:	b8 24 0f 00 00       	mov    $0xf24,%eax
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 a36:	0f 00 00 
    base.s.size = 0;
 a39:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 a40:	00 00 00 
    if(p->s.size >= nunits){
