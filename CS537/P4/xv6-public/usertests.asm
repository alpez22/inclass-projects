...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 58 55 00 00    	push   0x5558
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 58 55 00 00    	push   0x5558
     ...
     2a0:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 58 55 00 00    	push   0x5558
    ...
    exit();
     ...
     2ce:	ff 35 58 55 00 00    	push   0x5558
     ...
     2e5:	ff 35 58 55 00 00    	push   0x5558
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 58 55 00 00    	push   0x5558
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 58 55 00 00    	push   0x5558
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 58 55 00 00    	push   0x5558
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 58 55 00 00    	push   0x5558
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 58 55 00 00    	push   0x5558
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 58 55 00 00    	push   0x5558
     ...
     5de:	ff 35 58 55 00 00    	push   0x5558
     ...
     5f7:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 58 55 00 00    	push   0x5558
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 58 55 00 00    	push   0x5558
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6b3:	89 1d a0 7c 00 00    	mov    %ebx,0x7ca0
    if(write(fd, buf, 512) != 512){
     6b9:	68 00 02 00 00       	push   $0x200
     6be:	68 a0 7c 00 00       	push   $0x7ca0
     6c3:	56                   	push   %esi
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     71b:	a1 a0 7c 00 00       	mov    0x7ca0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     72f:	68 a0 7c 00 00       	push   $0x7ca0
     734:	53                   	push   %ebx
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 58 55 00 00    	push   0x5558
     ...
     793:	ff 35 58 55 00 00    	push   0x5558
     ...
     7aa:	ff 35 58 55 00 00    	push   0x5558
     ...
     7c3:	ff 35 58 55 00 00    	push   0x5558
     ...
     7de:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 58 55 00 00    	push   0x5558
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 58 55 00 00    	push   0x5558
     857:	e8 e4 31 00 00       	call   3a40 <printf>
  name[0] = 'a';
     85c:	c6 05 90 7c 00 00 61 	movb   $0x61,0x7c90
  name[2] = '\0';
     863:	83 c4 10             	add    $0x10,%esp
     866:	c6 05 92 7c 00 00 00 	movb   $0x0,0x7c92
  for(i = 0; i < 52; i++){
     86d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     870:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     873:	88 1d 91 7c 00 00    	mov    %bl,0x7c91
  for(i = 0; i < 52; i++){
     879:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     87c:	68 02 02 00 00       	push   $0x202
     881:	68 90 7c 00 00       	push   $0x7c90
  ...
  name[0] = 'a';
     89b:	c6 05 90 7c 00 00 61 	movb   $0x61,0x7c90
  name[2] = '\0';
     8a2:	bb 30 00 00 00       	mov    $0x30,%ebx
     8a7:	c6 05 92 7c 00 00 00 	movb   $0x0,0x7c92
  for(i = 0; i < 52; i++){
     8ae:	66 90                	xchg   %ax,%ax
    unlink(name);
     8b0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8b3:	88 1d 91 7c 00 00    	mov    %bl,0x7c91
  for(i = 0; i < 52; i++){
     8b9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8bc:	68 90 7c 00 00       	push   $0x7c90
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 58 55 00 00    	push   0x5558
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 58 55 00 00    	push   0x5558
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 58 55 00 00    	push   0x5558
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 58 55 00 00    	push   0x5558
     9e1:	e8 5a 30 00 00       	call   3a40 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 5c 55 00 00       	push   $0x555c
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 58 55 00 00    	push   0x5558
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6a:	57                   	push   %edi
     a6b:	68 a0 7c 00 00       	push   $0x7ca0
     ...
     a87:	32 05 a0 7c 00 00    	xor    0x7ca0,%al
     ...
     aa0:	38 90 a0 7c 00 00    	cmp    %dl,0x7ca0(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     afb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     afe:	88 90 9f 7c 00 00    	mov    %dl,0x7c9f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b19:	68 a0 7c 00 00       	push   $0x7ca0
...
00000bc0 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c6b:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    1036:	31 db                	xor    %ebx,%ebx
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10d8:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    10f2:	0f be 8a a0 7c 00 00 	movsbl 0x7ca0(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    11a1:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    11b6:	68 a0 7c 00 00       	push   $0x7ca0
    11bb:	56                   	push   %esi
...
00001430 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 a0 7c 00 00       	push   $0x7ca0
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d a0 7c 00 00 68 	cmpb   $0x68,0x7ca0
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 a0 7c 00 00       	push   $0x7ca0
    150b:	53                   	push   %ebx
...
000015c0 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 a0 7c 00 00       	push   $0x7ca0
    1699:	50                   	push   %eax
...
00001d10 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 a0 7c 00 00       	push   $0x7ca0
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d a0 7c 00 00 66 	cmpb   $0x66,0x7ca0
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 a0 7c 00 00       	push   $0x7ca0
    1f0a:	50                   	push   %eax
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    243e:	53                   	push   %ebx
    243f:	68 a0 7c 00 00       	push   $0x7ca0
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 a0 7c 00 00       	push   $0x7ca0
    245a:	56                   	push   %esi
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    258d:	0f be 05 a0 7c 00 00 	movsbl 0x7ca0,%eax
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 cb 7d 00 00 	movsbl 0x7dcb,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 a0 7c 00 00       	push   $0x7ca0
    25bb:	56                   	push   %esi
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 58 55 00 00    	push   0x5558
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2faa:	ff 35 58 55 00 00    	push   0x5558
    ...
    302e:	ff 35 58 55 00 00    	push   0x5558
    ...
    3049:	ff 35 58 55 00 00    	push   0x5558
    ...
    3063:	ff 35 58 55 00 00    	push   0x5558
    ...
    3082:	ff 35 58 55 00 00    	push   0x5558
    ...
    3099:	ff 35 58 55 00 00    	push   0x5558
    ...
    30b0:	ff 35 58 55 00 00    	push   0x5558
    ...
    30c7:	ff 35 58 55 00 00    	push   0x5558
    ...
    30de:	ff 35 58 55 00 00    	push   0x5558
    ...
    310d:	ff 35 58 55 00 00    	push   0x5558
    ...
    3124:	ff 35 58 55 00 00    	push   0x5558
    ...
    313b:	ff 35 58 55 00 00    	push   0x5558
    ...
    3152:	ff 35 58 55 00 00    	push   0x5558
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318f:	ff 35 58 55 00 00    	push   0x5558
  ...
  printf(stdout, "validate ok\n");
    ...
    31f9:	ff 35 58 55 00 00    	push   0x5558
    ...
    321b:	ff 35 58 55 00 00    	push   0x5558
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    323b:	ff 35 58 55 00 00    	push   0x5558
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    324f:	90                   	nop
    if(uninit[i] != '\0'){
    3250:	80 b8 80 55 00 00 00 	cmpb   $0x0,0x5580(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    326b:	ff 35 58 55 00 00    	push   0x5558
    ...
    3283:	ff 35 58 55 00 00    	push   0x5558
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32fb:	c7 04 85 a0 9c 00 00 	movl   $0x53b8,0x9ca0(,%eax,4)
    3302:	b8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 a0 9c 00 00 	movl   $0x53b8,0x9ca0(,%eax,4)
    3312:	b8 53 00 00 
    3316:	c7 04 85 a4 9c 00 00 	movl   $0x53b8,0x9ca4(,%eax,4)
    331d:	b8 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3332:	ff 35 58 55 00 00    	push   0x5558
    args[MAXARG-1] = 0;
    3338:	89 0d 1c 9d 00 00    	mov    %ecx,0x9d1c
    printf(stdout, "bigarg test\n");
    333e:	e8 fd 06 00 00       	call   3a40 <printf>
    exec("echo", args);
    3343:	58                   	pop    %eax
    3344:	5a                   	pop    %edx
    3345:	68 a0 9c 00 00       	push   $0x9ca0
    ...
    335b:	ff 35 58 55 00 00    	push   0x5558
    ...
    338b:	ff 35 58 55 00 00    	push   0x5558
    ...
    33a2:	ff 35 58 55 00 00    	push   0x5558
    ...
    33c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    348a:	68 a0 7c 00 00       	push   $0x7ca0
    348f:	57                   	push   %edi
...
00003670 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3670:	69 05 54 55 00 00 0d 	imul   $0x19660d,0x5554,%eax
    3677:	66 19 00 
    367a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    367f:	a3 54 55 00 00       	mov    %eax,0x5554
}
    3684:	c3                   	ret
    ...
    3a49:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3a63:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3a67:	90                   	nop
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3abb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3abf:	90                   	nop
        putc(fd, c);
      }
      state = 0;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bd1:	a1 20 9d 00 00       	mov    0x9d20,%eax
{
  ...
  freep = p;
    ...
    3c0f:	5b                   	pop    %ebx
  freep = p;
    3c10:	a3 20 9d 00 00       	mov    %eax,0x9d20
}
    3c15:	5e                   	pop    %esi
    3c16:	5f                   	pop    %edi
    3c17:	5d                   	pop    %ebp
    ...
    3c26:	72 ce                	jb     3bf6 <free+0x26>
{
  ...
  freep = p;
    3c4a:	a3 20 9d 00 00       	mov    %eax,0x9d20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c6c:	8b 15 20 9d 00 00    	mov    0x9d20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3cab:	3b 05 20 9d 00 00    	cmp    0x9d20,%eax
  ...
  return freep;
    3cd3:	8b 15 20 9d 00 00    	mov    0x9d20,%edx
    ...
    3cfc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3cff:	89 15 20 9d 00 00    	mov    %edx,0x9d20
}
    ...
    3d0f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3d10:	c7 05 20 9d 00 00 24 	movl   $0x9d24,0x9d20
    3d17:	9d 00 00 
    base.s.size = 0;
    3d1a:	b8 24 9d 00 00       	mov    $0x9d24,%eax
    base.s.ptr = freep = prevp = &base;
    3d1f:	c7 05 24 9d 00 00 24 	movl   $0x9d24,0x9d24
    3d26:	9d 00 00 
    base.s.size = 0;
    3d29:	c7 05 28 9d 00 00 00 	movl   $0x0,0x9d28
    3d30:	00 00 00 
    if(p->s.size >= nunits){
