...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb a8 0a 00 00       	mov    $0xaa8,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 a8 0a 00 00       	add    $0xaa8,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
...
0000062b <getwmapinfo>:
SYSCALL(getwmapinfo)
 62b:	b8 19 00 00 00       	mov    $0x19,%eax
 630:	cd 40                	int    $0x40
 632:	c3                   	ret

00000633 <getpgdirinfo>:
...
free(void *ap)
{
 ...
 871:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 8af:	5b                   	pop    %ebx
  freep = p;
 8b0:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 8b5:	5e                   	pop    %esi
 8b6:	5f                   	pop    %edi
 8b7:	5d                   	pop    %ebp
 ...
 8c6:	72 ce                	jb     896 <free+0x26>
{
 ...
 8e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8ea:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 909:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 90c:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 94b:	3b 05 b8 0a 00 00    	cmp    0xab8,%eax
 ...
 96e:	e8 fd fe ff ff       	call   870 <free>
  return freep;
 973:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 99c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 99f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 9af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 9b0:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 9b7:	0a 00 00 
    base.s.size = 0;
 9ba:	b8 bc 0a 00 00       	mov    $0xabc,%eax
    base.s.ptr = freep = prevp = &base;
 9bf:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 9c6:	0a 00 00 
    base.s.size = 0;
 9c9:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 9d0:	00 00 00 
    if(p->s.size >= nunits){
