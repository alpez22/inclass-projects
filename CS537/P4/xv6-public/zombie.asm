...
0000032b <getwmapinfo>:
SYSCALL(getwmapinfo)
 32b:	b8 19 00 00 00       	mov    $0x19,%eax
 330:	cd 40                	int    $0x40
 332:	c3                   	ret

00000333 <getpgdirinfo>:
...
free(void *ap)
{
 ...
 571:	a1 5c 07 00 00       	mov    0x75c,%eax
{
 ...
 5af:	5b                   	pop    %ebx
  freep = p;
 5b0:	a3 5c 07 00 00       	mov    %eax,0x75c
}
 5b5:	5e                   	pop    %esi
 5b6:	5f                   	pop    %edi
 5b7:	5d                   	pop    %ebp
 ...
 5c6:	72 ce                	jb     596 <free+0x26>
{
 ...
 5e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5ea:	a3 5c 07 00 00       	mov    %eax,0x75c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 5c 07 00 00    	mov    0x75c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64b:	3b 05 5c 07 00 00    	cmp    0x75c,%eax
 ...
 66e:	e8 fd fe ff ff       	call   570 <free>
  return freep;
 673:	8b 15 5c 07 00 00    	mov    0x75c,%edx
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 69f:	89 15 5c 07 00 00    	mov    %edx,0x75c
}
 ...
 6af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6b0:	c7 05 5c 07 00 00 60 	movl   $0x760,0x75c
 6b7:	07 00 00 
    base.s.size = 0;
 6ba:	b8 60 07 00 00       	mov    $0x760,%eax
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 60 07 00 00 60 	movl   $0x760,0x760
 6c6:	07 00 00 
    base.s.size = 0;
 6c9:	c7 05 64 07 00 00 00 	movl   $0x0,0x764
 6d0:	00 00 00 
    if(p->s.size >= nunits){
