...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 02 14 00 00 20 	cmpb   $0x20,0x1402
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 00 14 00 00       	push   $0x1400
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 00 14 00 00       	push   $0x1400
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 00 14 00 00 	movzbl 0x1400,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 01 14 00 00 64 	cmpb   $0x64,0x1401
  ...
  exit();
     ...
     105:	51                   	push   %ecx
     106:	68 03 14 00 00       	push   $0x1403
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    panic("runcmd");
     ...
     2cf:	68 b7 12 00 00       	push   $0x12b7
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 52 0e 00 00       	call   11a0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 22 0e 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 d2 0d 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     407:	6a 0c                	push   $0xc
     409:	e8 92 0d 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 52 0d 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 ec 13 00 00       	push   $0x13ec
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 e4 13 00 00       	push   $0x13e4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 ec 13 00 00       	push   $0x13ec
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 ec 13 00 00       	push   $0x13ec
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 d9 12 00 00       	push   $0x12d9
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6d0:	6a 18                	push   $0x18
     6d2:	e8 c9 0a 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     72f:	6a 18                	push   $0x18
     731:	e8 6a 0a 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     78e:	68 bc 12 00 00       	push   $0x12bc
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     7af:	68 dc 12 00 00       	push   $0x12dc
     7b4:	56                   	push   %esi
     7b5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7cb:	6a 54                	push   $0x54
     7cd:	e8 ce 09 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     816:	68 f3 12 00 00       	push   $0x12f3
     81b:	56                   	push   %esi
     81c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     860:	68 e5 12 00 00       	push   $0x12e5
  ...
  cmd->eargv[argc] = 0;
     ...
     8a9:	68 de 12 00 00       	push   $0x12de
...
000008c0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8d9:	68 f8 12 00 00       	push   $0x12f8
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     91d:	e8 7e 08 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000950 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     982:	e8 19 08 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     9ab:	68 fa 12 00 00       	push   $0x12fa
     9b0:	57                   	push   %edi
     9b1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9c1:	68 f6 12 00 00       	push   $0x12f6
     9c6:	57                   	push   %edi
     9c7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9fd:	e8 9e 07 00 00       	call   11a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a30 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a3f:	68 dc 12 00 00       	push   $0x12dc
     a44:	56                   	push   %esi
     a45:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a69:	68 18 13 00 00       	push   $0x1318
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 60 13 00 00 	jmp    *0x1360(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 a6 12 00 00       	push   $0x12a6
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 1a 13 00 00       	push   $0x131a
     bb5:	6a 02                	push   $0x2
     bb7:	e8 c4 03 00 00       	call   f80 <printf>
    panic("syntax");
     bbc:	c7 04 24 de 12 00 00 	movl   $0x12de,(%esp)
...
00000ecb <getwmapinfo>:
SYSCALL(getwmapinfo)
     ecb:	b8 19 00 00 00       	mov    $0x19,%eax
     ed0:	cd 40                	int    $0x40
     ed2:	c3                   	ret

00000ed3 <getpgdirinfo>:
     ...
     ee8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f56:	50                   	push   %eax
     f57:	56                   	push   %esi
     f58:	e8 d6 fe ff ff       	call   e33 <write>
  while(--i >= 0)
     ...
     f89:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fa3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     fa7:	90                   	nop
  ...
  write(fd, &c, 1);
     ...
     fc0:	50                   	push   %eax
     fc1:	57                   	push   %edi
     fc2:	e8 6c fe ff ff       	call   e33 <write>
  ...
  write(fd, &c, 1);
    ...
    1031:	52                   	push   %edx
    1032:	57                   	push   %edi
    1033:	e8 fb fd ff ff       	call   e33 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10da:	52                   	push   %edx
    10db:	57                   	push   %edi
    10dc:	e8 52 fd ff ff       	call   e33 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1111:	a1 64 14 00 00       	mov    0x1464,%eax
{
  ...
  freep = p;
    ...
    114f:	5b                   	pop    %ebx
  freep = p;
    1150:	a3 64 14 00 00       	mov    %eax,0x1464
}
    1155:	5e                   	pop    %esi
    1156:	5f                   	pop    %edi
    1157:	5d                   	pop    %ebp
    ...
    1166:	72 ce                	jb     1136 <free+0x26>
{
  ...
  freep = p;
    118a:	a3 64 14 00 00       	mov    %eax,0x1464
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11ac:	8b 15 64 14 00 00    	mov    0x1464,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11eb:	3b 05 64 14 00 00    	cmp    0x1464,%eax
    11f1:	75 ed                	jne    11e0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    11f3:	83 ec 0c             	sub    $0xc,%esp
    11f6:	56                   	push   %esi
    11f7:	e8 9f fc ff ff       	call   e9b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1213:	8b 15 64 14 00 00    	mov    0x1464,%edx
    ...
    123c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    123f:	89 15 64 14 00 00    	mov    %edx,0x1464
}
    ...
    124f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1250:	c7 05 64 14 00 00 68 	movl   $0x1468,0x1464
    1257:	14 00 00 
    base.s.size = 0;
    125a:	b8 68 14 00 00       	mov    $0x1468,%eax
    base.s.ptr = freep = prevp = &base;
    125f:	c7 05 68 14 00 00 68 	movl   $0x1468,0x1468
    1266:	14 00 00 
    base.s.size = 0;
    1269:	c7 05 6c 14 00 00 00 	movl   $0x0,0x146c
    1270:	00 00 00 
    if(p->s.size >= nunits){
