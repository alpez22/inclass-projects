 ...
 661:	a1 70 08 00 00       	mov    0x870,%eax
{
 ...
 69f:	5b                   	pop    %ebx
  freep = p;
 6a0:	a3 70 08 00 00       	mov    %eax,0x870
}
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 6a7:	5d                   	pop    %ebp
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 70 08 00 00       	mov    %eax,0x870
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 70 08 00 00    	mov    0x870,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73b:	3b 05 70 08 00 00    	cmp    0x870,%eax
 ...
 75e:	e8 fd fe ff ff       	call   660 <free>
  return freep;
 763:	8b 15 70 08 00 00    	mov    0x870,%edx
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 78f:	89 15 70 08 00 00    	mov    %edx,0x870
}
 ...
 79f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 70 08 00 00 74 	movl   $0x874,0x870
 7a7:	08 00 00 
    base.s.size = 0;
 7aa:	b8 74 08 00 00       	mov    $0x874,%eax
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 74 08 00 00 74 	movl   $0x874,0x874
 7b6:	08 00 00 
    base.s.size = 0;
 7b9:	c7 05 78 08 00 00 00 	movl   $0x0,0x878
 7c0:	00 00 00 
    if(p->s.size >= nunits){
