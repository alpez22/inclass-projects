  ...
  aa:	31 db                	xor    %ebx,%ebx
{
  ...
  f0:	74 3e                	je     130 <wc+0x90>
      if(buf[i] == '\n')
  f2:	0f be 87 00 09 00 00 	movsbl 0x900(%edi),%eax
        l++;
...
free(void *ap)
{
 ...
 6c1:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 6ff:	5b                   	pop    %ebx
  freep = p;
 700:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 707:	5d                   	pop    %ebp
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 00 0b 00 00       	mov    %eax,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 00 0b 00 00    	mov    0xb00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79b:	3b 05 00 0b 00 00    	cmp    0xb00,%eax
 ...
 7be:	e8 fd fe ff ff       	call   6c0 <free>
  return freep;
 7c3:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 7ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 04 0b 00 00       	mov    $0xb04,%eax
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 816:	0b 00 00 
    base.s.size = 0;
 819:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 820:	00 00 00 
    if(p->s.size >= nunits){
